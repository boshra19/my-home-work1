...
function handeldata(flats) {
    ...
    const dital = document.getElementById("dital1");
...
function newcreate(flat) {
    ...
    myflat.children[2].innerHTML = `${flat.price1}`;
    myflat.children[2].setAttribute("name", "price1");

    myflat.children[3].innerHTML = `${flat.dital1}`;
    myflat.children[3].setAttribute("name", "dital1");
...
function detalis(flat) {
    ...
    detcont.innerHTML = `    <div class="more-info">
                        <ul class="txt">
                            ...
                            <li  name="blkon" > مساحة بلكون : ${flat.masaha} </li>
                            <li  name="stuf" > مفروشة: ${flat.mafrosh} </li>
                            <li  name="haveingType" > الملكية: ${flat.have} </li>
                        </ul>
                        <div>
                            <img src="${flat.img1}" alt="">
                            <img src="${flat.img2}" alt="">
                            <img src="${flat.img3}" alt="">
                        </div>
                      </div>`;
